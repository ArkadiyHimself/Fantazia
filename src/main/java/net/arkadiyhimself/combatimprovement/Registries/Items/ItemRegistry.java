...
import net.arkadiyhimself.combatimprovement.Registries.Items.MagicCasters.ActiveAndTargeted.LifeDeathEntangler;
import net.arkadiyhimself.combatimprovement.Registries.Items.MagicCasters.ActiveAndTargeted.SculkHeart;
import net.arkadiyhimself.combatimprovement.Registries.Items.MagicCasters.ActiveAndTargeted.SoulEater;
...
public class ItemRegistry {
    ...
    static {
        ...
        STONE_HATCHET = regItem("stone_hatchet", () -> new Hatchet(Tiers.WOOD, 1, -2f, new Item.Properties(),"stone_hatchet"));
        IRON_HATCHET = regItem("iron_hatchet", () -> new Hatchet(Tiers.WOOD, 1, -2f, new Item.Properties(),"iron_hatchet"));
        GOLDEN_HATCHET = regItem("golden_hatchet", () -> new Hatchet(Tiers.WOOD, 1, -1.5f, new Item.Properties(),"golden_hatchet"));
        DIAMOND_HATCHET = regItem("diamond_hatchet", () -> new Hatchet(Tiers.WOOD, 1, -1.7f, new Item.Properties(),"diamond_hatchet"));
        NETHERITE_HATCHET = regItem("netherite_hatchet", () -> new Hatchet(Tiers.WOOD, 1, -1.6f, new Item.Properties(),"netherite_hatchet"));
    }
}
