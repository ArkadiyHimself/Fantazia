package net.arkadiyhimself.combatimprovement.client.Render.Models.Entity.VanillaTweaks.RenderAboveTypes;
...
public class StunBarType extends RenderStateShard {
    private static final ResourceLocation STUN_BAR = new ResourceLocation(CombatImprovement.MODID, "textures/render_above/stun_bar.png");
