...
public class LayeredBarrierLayer {
    public static final ResourceLocation BARRIER_LAYER = new ResourceLocation(CombatImprovement.MODID, "textures/entity_layers/layered_barrier/barrier_armor.png");
    public static final ResourceLocation BARRIER_BG = new ResourceLocation(CombatImprovement.MODID, "textures/entity_layers/layered_barrier/barrier_bg.png");
    ...
    public static class LayerBarrier<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T,M> {
        ...
        public void render(PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, T pLivingEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
            LayeredBarrierEffect.get(pLivingEntity).ifPresent(barrier -> {
                if (barrier.hasBarrier()) {
                    ...
                    entityModel.renderToBuffer(pPoseStack, pBufferBuffer, pPackedLight, OverlayTexture.NO_OVERLAY, 1F, 1F, 1F,0.5F * LayeredBarrierEffect.getUnwrap(pLivingEntity).color);
