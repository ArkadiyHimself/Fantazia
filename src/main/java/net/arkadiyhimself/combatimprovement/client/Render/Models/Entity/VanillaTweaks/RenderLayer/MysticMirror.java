package net.arkadiyhimself.combatimprovement.client.Render.Models.Entity.VanillaTweaks.RenderLayer;
...
public class MysticMirror {
    public static final ResourceLocation MIRROR_LAYER = new ResourceLocation(CombatImprovement.MODID, "textures/entity_layers/mystic_mirror/mystic_mirror.png");
    public static final ResourceLocation MIRROR_BG = new ResourceLocation(CombatImprovement.MODID, "textures/entity_layers/mystic_mirror/mirror_bg.png");
    ...
    public static class LayerMirror<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T,M> {
        ...
        public void render(PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, T pLivingEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
            AttachDataSync.get(pLivingEntity).ifPresent(dataSync -> {
                if (!dataSync.showMirrorLayer) { return; }
                pPoseStack.pushPose();
                float scale = dataSync.mirrorLayerSize;
                ...
                entityModel.renderToBuffer(pPoseStack, pBufferBuffer, pPackedLight, OverlayTexture.NO_OVERLAY, dataSync.mirrorLayerVis, dataSync.mirrorLayerVis, dataSync.mirrorLayerVis,0.175f * dataSync.mirrorLayerVis);
             //   VertexConsumer BGvertex = pBuffer.getBuffer(RenderType.entityTranslucent(MIRROR_BG));
             //   entityModel.renderToBuffer(pPoseStack, BGvertex, pPackedLight, OverlayTexture.NO_OVERLAY, 1F, 0.4F, 1F, 0.125F);
                pPoseStack.popPose();
            });
        }
