...
public class Spells {
    ...
    public final static PassiveSpell DAMNED_WRATH = new PassiveSpell(0f, 600, Fantazia.res("damned_wrath"), SoundRegistry.BLOODLUST_AMULET.get()).cleanse(Cleanse.MEDIUM);
}
