...
public class LayeredBarrierEffect extends EffectHolder implements IDamageReacting {
    ...
    public LayeredBarrierEffect(LivingEntity owner) {
        super(owner, MobEffectRegistry.LAYERED_BARRIER.get());
    }
    ...
    public void onHit(LivingHurtEvent event) {
        ...
        layers--;
        if (layers <= 0 && getOwner().hasEffect(MobEffectRegistry.LAYERED_BARRIER.get())) EffectCleansing.forceCleanse(getOwner(), MobEffectRegistry.LAYERED_BARRIER.get());
    }
}
