...
public class NewEvents {
    public static class ForgeExtenstion {
        ...
        public static boolean onEffectCleanse(LivingEntity living, MobEffectInstance effectInstance, Cleansing cleansing) {
            VanillaEventsExtension.CleanseEffectEvent event = new VanillaEventsExtension.CleanseEffectEvent(living, effectInstance, cleansing);
            return !MinecraftForge.EVENT_BUS.post(event);
        }
