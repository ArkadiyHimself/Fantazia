...
public class FTZAttachmentTypes {
    ...
    // niche features
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<ArrowEnchantmentsHolder>> ARROW_ENCHANTMENTS = register("niche.arrow_enchantments", AttachmentType.builder(ArrowEnchantmentsHolder::new).serialize(new ArrowEnchantmentsHolder.Serializer()));
    ...
    // simple features
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<TickingIntegerHolder>> ANCIENT_FLAME_TICKS = register("generic.ancient_flame_ticks", AttachmentType.serializable(iAttachmentHolder -> new TickingIntegerHolder(iAttachmentHolder, Fantazia.res("generic.ancient_flame"), false)));
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<TickingIntegerHolder>> MURASAMA_TAUNT_TICKS = register("weapon.murasama.taunt_ticks", AttachmentType.serializable(iAttachmentHolder -> new TickingIntegerHolder(iAttachmentHolder, Fantazia.res("weapon.murasama.taunt_ticks"),false)));
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<TickingIntegerHolder>> TRANQUILIZE_DAMAGE_TICKS = register("aura.tranquilize.damage_ticks", AttachmentType.serializable(iAttachmentHolder -> new TickingIntegerHolder(iAttachmentHolder, Fantazia.res("aura.tranquilize.damage_ticks"), false)));
