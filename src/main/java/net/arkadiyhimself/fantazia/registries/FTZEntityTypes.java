...
public class FTZEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<? extends ShockwaveEntity>> SHOCKWAVE = REGISTER.register("shockwave", () -> EntityType.Builder.<ShockwaveEntity>of(ShockwaveEntity::new, MobCategory.AMBIENT).sized(1.25f, 0.25f).build(Fantazia.res("shockwave").toString()));
