...
public class FTZAttributes {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAX_STUN_POINTS = REGISTER.register("max_stun_points", () -> new RangedAttribute("fantazia.attribute.max_stun_points", 300,1,4096));
    ...
    public static final DeferredHolder<Attribute, Attribute> LIFESTEAL = REGISTER.register("lifesteal", () -> new RangedAttribute("fantazia.attribute.recharge_multiplier", 0,0,16));
