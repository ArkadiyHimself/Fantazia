...
public class FTZAttributes {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAX_STAMINA = REGISTER.register("max_stamina", () ->  new RangedAttribute("fantazia.attribute.max_stamina", 20,0,4096).setSyncable(true));
    ...
    public static final DeferredHolder<Attribute, Attribute> CAST_RANGE_ADDITION = REGISTER.register("cast_range_addition", () -> new RangedAttribute("fantazia.attribute.cast_range_addition", 0, -256, 256).setSyncable(true));
    ...
    public static final DeferredHolder<Attribute, PercentageAttribute> RECHARGE_MULTIPLIER = REGISTER.register("recharge_multiplier", () -> new PercentageAttribute("fantazia.attribute.recharge_multiplier", 100).setSyncable(true));
