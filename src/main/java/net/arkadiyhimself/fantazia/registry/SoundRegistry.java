...
public class SoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> HEART_BEAT1; // implemented
    public static final RegistryObject<SoundEvent> HEART_BEAT2; // implemented
    ...
    static {
        HEART_BEAT1 = registerSoundEvent("fury_heartbeat1", 1f);
        HEART_BEAT2 = registerSoundEvent("fury_heartbeat2", 1f);
