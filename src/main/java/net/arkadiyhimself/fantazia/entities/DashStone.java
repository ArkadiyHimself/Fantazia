...
public class DashStone extends Entity {
    ...
    public static final EntityDataAccessor<Float> VISUAL_ROT0 = SynchedEntityData.defineId(DashStone.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Float> VISUAL_ROT1 = SynchedEntityData.defineId(DashStone.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Optional<UUID>> OWNER = SynchedEntityData.defineId(DashStone.class, EntityDataSerializers.OPTIONAL_UUID);
    ...
    public void playerTouch(@NotNull Player pPlayer) {
        TalentsHolder holder = PlayerAbilityHelper.takeHolder(pPlayer, TalentsHolder.class);
