...
public class ShockwaveEntity extends Entity {
    ...
    public static final EntityDataAccessor<Optional<UUID>> OWNER = SynchedEntityData.defineId(ShockwaveEntity.class, EntityDataSerializers.OPTIONAL_UUID);
    public static final EntityDataAccessor<Vector3f> DELTA = SynchedEntityData.defineId(ShockwaveEntity.class, EntityDataSerializers.VECTOR3);
    public static final EntityDataAccessor<Integer> LIFE = SynchedEntityData.defineId(ShockwaveEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Boolean> FURIOUS = SynchedEntityData.defineId(ShockwaveEntity.class, EntityDataSerializers.BOOLEAN);

    private UUID ownerUUID = null;
    private @Nullable Entity cachedOwner = null;
    private float cachedDamage;

    public ShockwaveEntity(EntityType<?> entityType, Level level) {
        super(entityType, level);
    }

    public ShockwaveEntity(Level level, Entity owner, float cachedDamage) {
