...
public class WorldCategoryEntries implements SubProvider<PseudoEntryHolder> {
    ...
    private void simpleLore(String entry, Item item, int pages, boolean unlocked) {
        ...
        ResourceLocation advancement = unlocked ? Fantazia.res(TheWorldlinessEntryHelper.THE_WORLDLINESS + "/" + world + "/" + entry) : null;
        ...
        builder.build().save(consumer, Fantazia.res(world + "/" + entry));
    }
