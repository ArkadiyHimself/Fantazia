...
public class DefaultTalents implements SubProvider<TalentBuilderHolder> {
    ...
    private static final ResourceLocation CIRCLE_BLUE = Fantazia.res("textures/gui/talent_icons/circle_blue.png");
    private static final ResourceLocation CIRCLE_LIGHT_BLUE = Fantazia.res("textures/gui/talent_icons/circle_light_blue.png");
    private static final ResourceLocation OCTAGON_WHITE = Fantazia.res("textures/gui/talent_icons/octagon_white.png");
    private static final ResourceLocation OCTAGON_BLUE = Fantazia.res("textures/gui/talent_icons/octagon_blue.png");
    private static final ResourceLocation OCTAGON_PURPLE = Fantazia.res("textures/gui/talent_icons/octagon_purple.png");
    private static final ResourceLocation SQUARE_WHITE = Fantazia.res("textures/gui/talent_icons/square_white.png");
    private static final ResourceLocation SQUARE_PURPLE = Fantazia.res("textures/gui/talent_icons/square_purple.png");
    private static final ResourceLocation SQUARE_RED = Fantazia.res("textures/gui/talent_icons/square_red.png");
    ...
    public void generate(HolderLookup.Provider provider, Consumer<TalentBuilderHolder> consumer) {
        ...
        createBuilder(Talents.DASH3,true).addImpact(TalentImpacts.DASH_UPGRADE).background(OCTAGON_PURPLE).save(consumer, Talents.DASH3);
        ...
        createBuilder(Talents.WALL_CLIMBING,true).addImpact(TalentImpacts.WALL_CLIMBING_UNLOCKED).save(consumer, Talents.WALL_CLIMBING);
        createBuilder(Talents.COBWEB_CLIMBING,false).addImpact(TalentImpacts.WALL_CLIMBING_COBWEB).wisdom(25).save(consumer, Talents.COBWEB_CLIMBING);
        createBuilder(Talents.POISON_ATTACK,false).addImpact(TalentImpacts.WALL_CLIMBING_POISON)
                ...
                .wisdom(50).save(consumer, Talents.POISON_ATTACK);
    }
