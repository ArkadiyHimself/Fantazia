...
public class SelfSpell extends AbstractSpell implements IChanneled {
    ...
    public SpellCastResult onCast(LivingEntity livingEntity, int ampl) {
        if (doCleanse()) EffectCleansing.tryCleanseAll(livingEntity, cleanse(), MobEffectCategory.BENEFICIAL);
    ...
    public static class Builder extends SpellBuilder<SelfSpell> {
        ...
        private BiFunction<LivingEntity, Integer, SpellCastResult> onCast = (livingEntity, integer) -> SpellCastResult.DEFAULT;
