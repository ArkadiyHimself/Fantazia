...
import net.arkadiyhimself.fantazia.common.api.custom_events.*;
...
public class FantazicHooks {
    ...
    public static class ForgeExtension {
        ...
        public static VanillaEventsExtension.CleanseEffectEvent onEffectCleanse(LivingEntity living, MobEffectInstance effectInstance, Cleanse cleanse) {
