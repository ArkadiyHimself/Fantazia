...
public class SimpleMobEffect extends MobEffect {
    ...
    @Override
    public @NotNull SimpleMobEffect addAttributeModifier(@NotNull Holder<Attribute> attribute, @NotNull ResourceLocation id, AttributeModifier.@NotNull Operation operation, @NotNull Int2DoubleFunction curve) {
        super.addAttributeModifier(attribute, id, operation, curve);
        return this;
    }
