...
public class HealingTypes {
    ...
    public static final HealingType LIFESTEAL = new HealingType(0f, Fantazia.res("lifesteal"), HealingTag.SCALES_FROM_SATURATION, HealingTag.SELF, HealingTag.UNHOLY)
            .setRegParticles(ParticleRegistry.lifestealParticles);
    public static final HealingType REGEN_EFFECT = new HealingType(0f, Fantazia.res("regen_effect"), HealingTag.SCALES_FROM_SATURATION, HealingTag.REGEN).setRegParticles(ParticleRegistry.regenParticles);
