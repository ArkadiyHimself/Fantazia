...
public class BarrierLayer {
    ...
    public static final ResourceLocation BARRIER_LAYER = Fantazia.location("textures/entity_layers/barrier/barrier_armor.png");
    public static final ResourceLocation BARRIER_BG = Fantazia.location("textures/entity_layers/barrier/barrier_bg.png");
    public static final ResourceLocation BARRIER_LAYER_FURY = Fantazia.location("textures/entity_layers/barrier/barrier_armor_fury.png");
    public static final ResourceLocation BARRIER_BG_FURY = Fantazia.location("textures/entity_layers/barrier/barrier_bg_fury.png");
