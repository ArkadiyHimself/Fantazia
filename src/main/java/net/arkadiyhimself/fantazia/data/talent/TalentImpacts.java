...
public class TalentImpacts {
    ...
    static {
        ...
        EUPHORIA_RELENTLESS = register(TalentImpact.builder(Fantazia.res("euphoria.relentless"))
        ...
        EUPHORIA_SAVAGE = register(TalentImpact.builder(Fantazia.res("euphoria.savage"))
        ...
        MANA_RECYCLE_UPGRADE = register(TalentImpact.builder(Fantazia.res("mana_recycle.upgrade"))
                .apply(player -> {
