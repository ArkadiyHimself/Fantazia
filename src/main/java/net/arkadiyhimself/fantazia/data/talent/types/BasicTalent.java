...
public class BasicTalent implements ITooltipBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        else if (!(obj instanceof BasicTalent basicTalent)) return false;
        else return basicTalent.getID().equals(this.getID());
    }

    public static final class Builder implements ITalentBuilder<BasicTalent> {
