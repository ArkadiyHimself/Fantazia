...
import net.arkadiyhimself.fantazia.common.registries.FTZCreativeModeTabs;
...
public class TheWorldlinessProvider implements DataProvider {
    ...
    public @NotNull CompletableFuture<?> run(@NotNull CachedOutput cachedOutput) {
        return registries.thenCompose(provider -> {
            ...
            Path path = this.pathProvider.json(Fantazia.location("book"));
    ...
    private static class TheWorldliness {
        static final Codec<TheWorldliness> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                ...
                ResourceLocation.CODEC.fieldOf("book_texture").forGetter(b -> Fantazia.location("textures/gui/the_worldliness.png")),
                ResourceLocation.CODEC.fieldOf("crafting_texture").forGetter(b -> Fantazia.location("textures/gui/the_worldliness_crafting.png")),
