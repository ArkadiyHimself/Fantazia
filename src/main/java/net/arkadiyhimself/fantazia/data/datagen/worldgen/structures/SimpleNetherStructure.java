package net.arkadiyhimself.fantazia.data.datagen.worldgen.structures;

import com.mojang.serialization.Codec;
import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.arkadiyhimself.fantazia.common.registries.FTZStructureTypes;
...
public class SimpleNetherStructure extends Structure {
    ...
    public static final MapCodec<SimpleNetherStructure> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            settingsCodec(instance),
            StructureTemplatePool.CODEC.fieldOf("start_pool").forGetter(structure -> structure.startPool),
            Codec.INT.fieldOf("size_to_check").forGetter(structure -> structure.sizeToCheck)).apply(instance, SimpleNetherStructure::new));
