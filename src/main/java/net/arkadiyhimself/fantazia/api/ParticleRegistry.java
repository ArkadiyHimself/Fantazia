...
public class ParticleRegistry {
    ...
    public static RegistryObject<SimpleParticleType> registerBarrierPiece(final String name, final Supplier<? extends SimpleParticleType> sup) {
        RegistryObject<SimpleParticleType> particle = PARTICLES.register(name, sup);
        barrierPiecesParticles.add(particle);
        return particle;
    }
    public static RegistryObject<SimpleParticleType> registerLifesteal(final String name, final Supplier<? extends SimpleParticleType> sup) {
        RegistryObject<SimpleParticleType> particle = PARTICLES.register(name, sup);
        lifestealParticles.add(particle);
        return particle;
    }
    ...
    public static ArrayList<RegistryObject<SimpleParticleType>> barrierPiecesParticles = new ArrayList<>();
    public static ArrayList<RegistryObject<SimpleParticleType>> lifestealParticles = new ArrayList<>();
    public static ArrayList<RegistryObject<SimpleParticleType>> regenParticles = new ArrayList<>();
