...
public interface IPacket extends CustomPacketPayload {
    ...
    static void arrowIsFurious(Arrow arrow) {
        PacketDistributor.sendToPlayersTrackingEntityAndSelf(arrow, new ArrowIsFurious(arrow.getId()));
    }
    ...
    static void hatchetRemoved(LivingEntity entity) {
        PacketDistributor.sendToPlayersTrackingEntityAndSelf(entity, new HatchetRemovedSC2(entity.getId()));
    }

    static void hatchetStuck(LivingEntity entity, ItemStack stack) {
        PacketDistributor.sendToPlayersTrackingEntityAndSelf(entity, new HatchetStuckSC2(entity.getId(), stack));
    }
